...
const setPlayerCards = (arr = players) => {
  return playerCards.innerHTML += arr.map(({name, position, number, isCaptain, nickname}) => {
  return  `
    ...
    `
  }).join("")// join removes the comma from array and concats all te item of the array
}
